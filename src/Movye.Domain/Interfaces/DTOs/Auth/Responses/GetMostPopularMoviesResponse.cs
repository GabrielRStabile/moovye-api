...
{
    public class GetMostPopularMoviesResponse
    {
        public GetMostPopularMoviesResponse(Movie[] movies)
        {
            Movies = movies;
        }
        ...
        public static GetMostPopularMoviesResponse FromModel(
            GetMostPopularMoviesResponseModel model
        )
        {
