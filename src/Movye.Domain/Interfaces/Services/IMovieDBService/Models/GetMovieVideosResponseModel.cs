...
namespace Movye.Domain.Interfaces.Services.IMovieDBService.Models
{
    ...
    public partial class GetMovieVideosResponseModel
    {
    ...
    public partial class VideosResult
    {
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    public partial class GetMovieVideosResponseModel
    {
        public static GetMovieVideosResponseModel FromJson(string json) => JsonSerializer.Deserialize<GetMovieVideosResponseModel>(json, VideoConverter.Settings);
    }
